...
mcp = FastMCP("Microsoft")

# Add an stock check tool
@mcp.tool()
def get_msft_stock_information() -> dict:
     """Add your logic... Returns current stock information for MSFT"""
     return {
        "symbol": "MSFT",
...
@mcp.tool()
def get_msft_popular_products() -> dict:
     """Add your logic... Returns popular Microsoft products."""
     return {
