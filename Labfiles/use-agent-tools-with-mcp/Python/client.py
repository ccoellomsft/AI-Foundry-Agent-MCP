...
async def chat_loop(session):
    ...
    agent = agents_client.create_agent(
     ...
     name="msft-agent",
     instructions="""
     You are an information assistant on Microsoft.
     """,
    ...
    while True:
        user_input = input("Enter a prompt for the information agent. Use 'quit' to exit.\nUSER: ").strip()
        ...
        # print("Deleted information agent.")
